                 ...
                 Column(
                  ...
                  Column(
                    children: const [
                      ...
                      SizedBox(height: 6,),
                      Text("Materials",style:TextStyle(fontSize:10,color: Colors.white)),
                    ],
                  ),
                  const SizedBox(width:55),
                  Column(
                    children:const [
                      ...
                      SizedBox(height: 6,),
                      Text("Assignments",style: TextStyle(fontSize:10,color: Colors.white),),
                    ],
                  )
              ],
            ),
